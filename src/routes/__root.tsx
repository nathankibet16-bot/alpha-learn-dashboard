...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Alpha Trader Group" },
      { name: "description", content: "Alpha Trader Group — crypto trader portal for tracking balance, deposits, withdrawals, and live markets." },
      { property: "og:title", content: "Alpha Trader Group" },
